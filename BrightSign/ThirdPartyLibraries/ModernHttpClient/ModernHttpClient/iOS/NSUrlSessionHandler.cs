...
namespace ModernHttpClient
{
    ...
    public class NativeMessageHandler : HttpClientHandler
    {
        ...
        public bool _enableUntrustedCertificates;
        ...
        class DataTaskDelegate : NSUrlSessionDataDelegate
        {
            ...
            doDefault:
                if(This._enableUntrustedCertificates == true){
                    NSUrlCredential cred = NSUrlCredential.FromTrust(challenge.ProtectionSpace.ServerSecTrust);
