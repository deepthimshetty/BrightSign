...
namespace ModernHttpClient
{
    public class NativeMessageHandler : HttpClientHandler
    {
        ...
        private bool _enableUntrustedCertificates;
        public void EnableUntrustedCertificates() { 
            _enableUntrustedCertificates = true;
            try{
                IX509TrustManager[] trustAllCerts = {new TrustManager()};
        ...
        {
            #region IHostnameVerifier implementation
		...
		public class TrustManager : Java.Lang.Object , IX509TrustManager
        {

            #region IX509TrustManager implementation
